...
- `evidence/`: sanitized machine-readable execution and validation proof.

Start with the repository root `README.md`; use these documents for deeper
technical or interview detail.
